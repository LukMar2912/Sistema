...
namespace C_Datos
{
    public class ClassDatos
    {
        ...
        public DataTable D_buscar_clientes_nombre(ClassEntidad obje)
        {
            SqlCommand cmd = new SqlCommand("sp_buscar_clientes_nombre", cn);
        ...
        public DataTable D_buscar_clientes_codigo(ClassEntidad obje)
        {
            SqlCommand cmd = new SqlCommand("sp_buscar_clientes_codigo", cn);
            cmd.CommandType = CommandType.StoredProcedure;
